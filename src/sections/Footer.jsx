 ...
 */
const socials = [
  { Icon: FaYoutube, label: "YouTube", href: "https://youtube.com/@kunalchachane3941?si=3VX8fw1gEx-zg4TK" },
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/kunal-chachane-ab1984316" },
  { Icon: FaGithub, label: "GitHub", href: "https://github.com/kunalchachane" },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Kunal Chachane. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
