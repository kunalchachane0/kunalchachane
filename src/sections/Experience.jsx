...
const experiences = [
  {
    ...
    company: "Bharti Krishna Vidya Vihar",
    duration: "2021",
    description:
      "Completed secondary education with a strong academic foundation, active participation in school activities, and consistent performance across subjects.",
  },
  
  {
    ...
    duration: "2023",
    description:
      "Completed the Higher Secondary Certificate with a focus on developing analytical, communication, and problem-solving skills.",
  },
{
    role: "Bachelor of Engineering in Computer Science",
    company: "SB Jain Institute of Technology, Management and Research",
    duration: "2023 – 2027",
    description:
      "Successfully completed a Computer Science degree with strong foundations in algorithms, software development, data structures, and system design.",
  },
